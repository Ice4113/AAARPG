...
@export var throw_height_stregnth : float = 100.0
@export var throw_staring_height : float = 49
...
func throw() -> void:
	...
	object_sprite.position.y = -throw_staring_height
	vertical_velocity = -throw_height_stregnth
...
func diable_collisions(_node : Node) -> void:
