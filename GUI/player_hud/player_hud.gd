...
@export var button_focus_audio :AudioStream = preload("res://tiltle_scene/audio/menu_focus.wav")
@export var button_select_audio : AudioStream = preload("res://tiltle_scene/audio/menu_select.wav")
...
func title_screen() -> void:
	play_audio(button_select_audio)
	await fade_to_black()
	LevelManager.load_new_level("res://tiltle_scene/title_scene.tscn","",Vector2.ZERO)
